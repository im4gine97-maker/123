...
def fetch_governance_criticism(tk, cd, ceo_name):
    ...
    db = {
        ...
        "AAPL": "팀 쿡 (Tim Cook): 팀 쿡의 공급망 및 자본배분은 신뢰도가 높으나, 하드웨어 혁신 정체 및 반독점 소송이 치명적 리스크입니다. (이건 확인이 필요한 부분입니다)",
        ...
        "LLYVK": "Liberty Live Holdings: 존 말론의 복잡한 지배구조 설계 능력은 신뢰하나, 미디어 업황 위축 및 복잡성은 이건 확인이 필요한 부분입니다.",
        "LLYVA": "Liberty Live Holdings: 존 말론의 복잡한 지배구조 설계 능력은 신뢰하나, 미디어 업황 위축 및 복잡성은 이건 확인이 필요한 부분입니다.",
