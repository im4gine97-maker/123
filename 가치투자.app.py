...
# (기존 tmap에 이미 존재하는 기업은 제외하고 공식 명칭으로만 구성)
# =========================================================================
new_tickers_to_add = {
    # ===== KOSPI 상위 (기존에 없는 종목) =====
    ...
    # ===== S&P 500 & NASDAQ 200 상위 (기존 빅테크/가치주 제외) =====
...
# =========================================================================
# [사용자 맞춤형 대규모 추가] 유저 관심종목 리스트 140여 개 추가
# =========================================================================
user_custom_tickers = {
