...
def fetch_governance_criticism(tk, cd, ceo_name):
    ...
    db = {
        ...
        "OXY": "옥시덴탈 페트롤리움: 장점: 퍼미안 셰일 유전의 독보적 입지와 수직계열화로 잉여현금 극대화 및 강력한 현금 창출력을 입증했습니다.\n단점: 무리한 대형 인수로 인한 막대한 부채 부담 및 레버리지 리스크가 있으며 유가 사이클 변동성에 취약합니다.",
        "HHH": "하워드 휴즈: 장점: 마스터플랜 커뮤니티(MPC) 토지 개발 부문의 독점적 우위와 장기적인 주당가치 제고 역량을 지녔습니다.\n단점: 부동산 개발을 위한 부채 부담 및 레버리지가 존재하며 고금리 및 부동산 침체 사이클에 따른 둔화 우려가 있습니다.",
        "QSR": "레스토랑 브랜즈: 장점: 프랜차이즈 수수료 기반 모델로 압도적인 마진과 탁월한 자본수익률, 안정적인 현금 창출력을 확보했습니다.\n단점: 과거 가맹점주와의 규제 마찰 및 소송 리스크가 상존하며, 패스트푸드 경쟁 격화 및 부채 부담이 약점입니다.",
        "ELV": "엘리번스 헬스: 장점: 미국 블루크로스 네트워크를 기반으로 확고한 시장 장악과 자사주 매입, 연속 배당 성장을 실천합니다.\n단점: 정부 보험금 과다 청구 관련 집단소송 및 배상금 리스크, 의료비 심사 관련 규제 마찰이 상존합니다.",
        "FERG": "퍼거슨: 장점: 북미 배관 및 공조 설비 B2B 유통 1위로서 독보적 시장 장악력과 탁월한 자본수익률, 자사주 매입을 지속합니다.\n단점: 건설 및 주택 개보수 경기 침체 사이클에 민감하며 원자재 가격 변동성에 따른 수익성 둔화 우려가 있습니다.",
        "GPC": "제뉴인 파츠: 장점: NAPA 자동차 부품 유통 1위의 우위를 바탕으로 60년 이상의 연속 배당 성장을 달성한 주주친화 기업입니다.\n단점: 거시경제 둔화에 따른 물류비 상승으로 마진 희석 우려가 있으며, 장기적인 부품 수요 정체 리스크가 있습니다.",
        "EWBC": "이스트웨스트 뱅코프: 장점: 미중 무역 특화 은행으로서 철저한 ROE 관리와 검증된 리스크 통제로 안정적 흑자 달성을 유지합니다.\n단점: 미중 간 지정학적 마찰에 취약하며 상업용 부동산 침체 사이클에 따른 대손 부채 부담 우려가 있습니다.",
        "CROX": "크록스: 장점: 독창적 폼 슈즈의 압도적인 마진을 바탕으로 폭발적인 잉여현금 극대화와 자사주 매입을 실행 중입니다.\n단점: 헤이듀드 브랜드의 무리한 인수로 부채 부담이 늘어났으며, 단일 유행 패션 이탈 및 매출 둔화 우려가 있습니다.",
        "MCO": "무디스: 장점: 글로벌 신용평가 시장의 독점적 과점을 바탕으로 압도적인 마진과 탁월한 자본수익률, 교과서적 자본 배분을 증명합니다.\n단점: 과거 금융위기 당시 신용등급 조작 및 은폐 혐의로 거액의 과징금과 배상금을 물었으며 채권 발행 침체 사이클에 취약합니다.",
        "KKR": "KKR: 장점: 글로벌 대체투자 1위권 운용사로서 영구자본 구조를 완결형으로 구축해 탁월한 자본수익률과 현금 창출력을 보입니다.\n단점: 차입 매수에 따른 높은 레버리지 및 부채 부담이 있으며, 피인수 기업 구조조정 관련 노무 소송과 경기 침체에 민감합니다.",
        "FICO": "페어 아이작: 장점: 미국 신용점수 시장의 독점적 지배력과 압도적인 마진을 바탕으로 강력한 자사주 매입과 주당가치 제고를 달성했습니다.\n단점: 일방적인 가격 인상으로 인한 반독점 독점 규제 조사와 금융당국과의 규제 마찰 및 경쟁사 잠식 우려가 있습니다.",
        "ROP": "로퍼 테크놀로지스: 장점: 틈새 소프트웨어 포트폴리오를 통해 잉여현금 극대화와 탁월한 자본수익률, 연속 배당 성장을 실천하는 우량 기업입니다.\n단점: 지속적인 M&A 과정에서 누적된 부채 부담과 레버리지 위험이 있으며 인수 기업 간 시너지 둔화 우려가 있습니다.",
        "HCC": "워리어 메트 콜: 장점: 제철용 원료탄 부문의 원가 우위를 바탕으로 파격적인 주주가치 환원과 강력한 현금 창출력을 자랑합니다.\n단점: 과거 장기 파업 등 가혹한 노동 환경 관련 노무 소송을 겪었으며 환경 파괴 규제와 석탄 사이클 변동성에 매우 취약합니다.",
        "RIG": "트랜스오션: 장점: 초심해 원유 시추선 분야에서 독보적 기술력과 시장 장악 우위를 선점하고 있습니다.\n단점: 멕시코만 원유 유출 사망 참사 관련 유죄 판결 및 거액의 배상금 이력이 있으며, 막대한 부채 부담과 시추선 적자 방치, 유가 사이클에 취약합니다.",
        "AMR": "알파 메탈러지컬: 장점: 잉여현금 극대화를 통해 시가총액의 상당 부분을 자사주 매입 및 소각에 쏟아붓는 교과서적 자본 배분을 보여줍니다.\n단점: 과거 파산 보호 신청 흑역사가 있으며, 광산 노동 환경 안전사고와 환경 파괴 규제, 제철용 석탄 사이클 변동성이 극심합니다.",
        "KSPI": "카스피: 장점: 카자흐스탄 결제·커머스 생태계를 독점적 수준으로 장악해 압도적인 마진과 철저한 ROE, 연속 배당 성장을 달성했습니다.\n단점: 공매도 기관의 대러시아 제재 우회 불법 금융 거래 의혹 등 불투명한 거버넌스 리스크와 중앙아시아 지정학적 변동성이 큽니다.",
        "RACE": "페라리: 장점: 슈퍼카 시장의 독보적 지위와 프리미엄 가격 결정력을 바탕으로 압도적인 마진과 탁월한 자본수익률을 기록 중입니다.\n단점: 엄격해지는 탄소 배출 규제 마찰과 전기차 전환에 따른 R&D 비용 부담, 글로벌 럭셔리 소비 침체 둔화 우려가 있습니다.",
        "DJCO": "데일리 저널: 장점: 정직을 바탕으로 한 포트폴리오 운용과 법원 소프트웨어 사업의 안정적 현금 창출력 우위를 지녔습니다.\n단점: 찰리 멍거 사후 뚜렷한 후계 구도에 대한 키맨 리스크와 지배구조 불안이 있으며, 전통 언론 부문의 외형 성장 정체가 지속됩니다.",
        "CSCO": "시스코: 장점: 엔터프라이즈 네트워킹 장비 시장 장악력을 바탕으로 강력한 잉여현금 극대화와 연속 배당 성장, 자사주 매입을 실천하는 주주친화 기업입니다.\n단점: 클라우드 화이트박스 스위치 확산에 따른 점유율 잠식 및 성장 둔화 우려가 있으며, 과거 공공 입찰 관련 규제 마찰 및 과징금 제재 이력이 있습니다.",
        "PLTR": "팔란티어: 장점: 정부 및 국방 AI 플랫폼 시장을 선점하여 독보적 지위를 확보하고 흑자 달성 및 압도적인 마진 개선 궤도에 올랐습니다.\n단점: 과거 과도한 주식보상(SBC) 발행에 따른 주주가치 희석 논란이 있었으며, 창업자 차등의결권에 따른 통제 리스크와 정부 감시 관련 소송 리스크가 상존합니다.",
        
        "402340": "SK스퀘어: 장점: SK하이닉스 배당 수취 및 포트폴리오 리밸런싱을 바탕으로 자사주 매입과 전량 소각 등 적극적인 주주환원과 주당가치 제고를 추진합니다.\n단점: 계열사 차입 M&A에 따른 부채 부담과 오너 사법 리스크 연동에 따른 지배구조 불안 및 주주가치 훼손 우려가 상존합니다.",
        "096770": "SK이노베이션: 장점: 정유 및 석유화학 본업에 집중하여 탄탄한 현금 창출력을 유지하며, E&S 합병을 통한 완결형 에너지 포트폴리오를 구축했습니다.\n단점: 핵심 배터리 사업부(SK온) 물적분할로 심각한 주주가치 훼손 및 주주가치 희석 논란을 빚었으며, 무리한 합병 비율 추진과 배터리 적자 방치, 부채 부담이 큽니다.",
        "034020": "두산에너빌리티: 장점: 글로벌 원전 주기기 및 SMR 시장 장악력을 바탕으로 기술 선점 및 안정적 수주 우위를 확보했습니다.\n단점: 과거 대규모 분식회계 적발로 과징금 제재를 받았으며, 계열사 지배구조 개편 시 불공정 합병 비율 강행으로 거버넌스 붕괴 및 주주가치 훼손 비판을 받았습니다.",
        "009150": "삼성전기: 장점: MLCC 및 고부가 반도체 패키지기판(FC-BGA) 부문 1위권 기술력으로 안정적 흑자 달성을 증명하고 있습니다.\n단점: IT 및 스마트폰 전방 수요 침체 사이클 변동성에 취약하며, 글로벌 선두사와의 가격 경쟁 격화로 인한 점유율 잠식 및 마진 희석 우려가 있습니다.",
        "012450": "한화에어로스페이스: 장점: K-방산 수출 시장 장악을 바탕으로 압도적인 수주 잔고와 폭발적인 수익성 개선을 증명하고 있습니다.\n단점: 그룹 승계 과정에서의 잦은 분할합병으로 주주가치 희석 논란이 있었으며, 방산 기술 기밀 유출 관련 정부 제재 및 소송 리스크와 수주 사이클 변동성이 존재합니다.",
    }
