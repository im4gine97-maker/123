...
def fetch_governance_criticism(tk, cd, ceo_name):
    ...
    db = {
        ...
        "AAPL": "애플: 장점: 팀 쿡 경영진은 압도적인 마진을 바탕으로 꾸준한 자사주 매입과 주당가치 제고를 실행하며 워런 버핏이 극찬하는 교과서적 자본 배분을 증명했습니다.\n단점: 폐쇄적인 플랫폼 운영 고수로 인해 앱스토어 수수료 관련 반독점 및 독점 규제 소송 리스크를 자초하고 있습니다.",
        ...
        "COST": "코스트코: 장점: 경영진은 마진을 극도로 제한하고 멤버십 회원들에게만 이익을 돌려주는 찰리 멍거가 극찬한 '상생' 철학을 뚝심 있게 고수하여 전 세계 소비자들에게 가장 신뢰받는 유통 1위 기업이 되었습니다.\n단점: 과거 명품 상표(티파니)를 무단 도용 판매해 법원으로부터 막대한 배상금 제재를 받은 뼈아픈 오점이 있으며, 디지털 이커머스 전환 둔화 약점이 늘 지적됩니다.",
