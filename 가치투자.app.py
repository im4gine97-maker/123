...
def fetch_governance_criticism(tk, cd, ceo_name):
    ...
    db = {
        ...
        "AAPL": "애플: 장점: 압도적인 마진을 바탕으로 한 자사주 매입과 주당가치 제고로 교과서적 자본 배분을 보여줍니다.\n단점: 혁신 정체 우려와 앱스토어 수수료 관련 반독점 및 독점 규제 리스크가 상존합니다.",
        "MSFT": "마이크로소프트: 장점: AI 시장 선점으로 확고한 시장 장악에 성공했고, 투명한 소통으로 가장 신뢰받는 기업입니다.\n단점: 막대한 인프라 투자로 인한 마진 희석 우려와 글로벌 독점 규제의 주요 타겟이 되고 있습니다.",
        "BRK-A": "버크셔 해서웨이: 장점: 정직을 최우선으로 교과서적 자본 배분을 실천하며, 시장에서 가장 신뢰받는 지주회사입니다.\n단점: 워렌 버핏 이후 시대를 대비해야 하는 명백한 키맨 리스크가 유일한 약점입니다.",
        "BRK-B": "버크셔 해서웨이: 장점: 정직을 최우선으로 교과서적 자본 배분을 실천하며, 시장에서 가장 신뢰받는 지주회사입니다.\n단점: 워렌 버핏 이후 시대를 대비해야 하는 명백한 키맨 리스크가 유일한 약점입니다.",
        "AMZN": "아마존: 장점: 과투자를 줄이고 본업에 집중하여 잉여현금 극대화 및 폭발적인 수익성 개선을 이뤄냈습니다.\n단점: 물류 센터 노동 환경 관련 노무 이슈 및 반독점 규제와 소송 리스크가 상존합니다.",
        "GOOGL": "알파벳: 장점: 검색 시장에서 독보적 지위를 통해 안정적이고 강력한 현금 창출력을 유지하고 있습니다.\n단점: AI 경쟁 격화로 인한 해자 잠식 우려와 강력한 반독점 및 독점 규제 압박을 받고 있습니다.",
        "GOOG": "알파벳: 장점: 검색 시장에서 독보적 지위를 통해 안정적이고 강력한 현금 창출력을 유지하고 있습니다.\n단점: AI 경쟁 격화로 인한 해자 잠식 우려와 강력한 반독점 및 독점 규제 압박을 받고 있습니다.",
        "META": "메타: 장점: 강력한 구조조정으로 수익성 개선을 이루고, 사상 첫 배당 등 적극적인 주주환원을 실행 중입니다.\n단점: CEO 1인에게 집중된 통제 리스크가 크며, 과거 개인정보 유출 관련 집단소송 이력이 있습니다.",
        "AXP": "아메리칸 익스프레스: 장점: 철저한 ROE 관리와 프리미엄 고객 우위를 바탕으로 연속 배당 성장을 이루는 주주친화적 기업입니다.\n단점: 거시경제 침체 시 대손충당금 증가 등 경제 사이클에 따른 변동성 우려가 있습니다.",
        "KO": "코카콜라: 장점: 연속 배당 성장의 대명사로 전 세계적인 브랜드 장악력과 안정적인 현금흐름을 자랑합니다.\n단점: 건강 트렌드 확산에 따른 장기적인 외형 성장 정체 및 수익성 둔화 리스크가 있습니다.",
        "MA": "마스터카드: 장점: 결제 네트워크의 독점적 지위를 바탕으로 압도적인 마진과 탁월한 자본수익률을 기록 중입니다.\n단점: 가맹점 수수료 관련 집단소송 및 각국 정부와의 규제 마찰이 지속적인 위협 요소입니다.",
        "V": "비자: 장점: 결제 네트워크의 독점적 지위를 바탕으로 압도적인 마진과 탁월한 자본수익률을 기록 중입니다.\n단점: 가맹점 수수료 관련 집단소송 및 각국 정부와의 규제 마찰이 지속적인 위협 요소입니다.",
        "BN": "브룩필드: 장점: 실물 자산 투자에서 검증된 역량으로 탁월한 자본수익률을 올리며 장기적 수익성 개선을 증명합니다.\n단점: 자산 매입을 위한 높은 레버리지 및 부채 부담이 있으며, 지배구조 불안(복잡성)이 단점입니다.",
        "UBER": "우버: 장점: 글로벌 모빌리티 시장 장악력을 바탕으로 흑자 달성 및 잉여현금 극대화 구간에 진입했습니다.\n단점: 기사 분류 위헌 등 노동 환경 및 노무 관련 집단소송과 규제 마찰이 잦습니다.",
        "PDD": "핀둬둬: 장점: 초저가 전략으로 단기간에 압도적인 수익성 개선과 글로벌 이커머스 시장 장악력을 확보했습니다.\n단점: 재무 상태와 소통이 불투명한 편이며, 가혹한 노동 환경과 지정학적 마찰 리스크가 큽니다.",
    }
