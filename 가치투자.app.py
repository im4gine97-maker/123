...
def fetch_governance_criticism(tk, cd, ceo_name):
    ...
    db = {
        "BABA": "알리바바 그룹 (경영자: 에디 우 / 차이충신): 클라우드·AI 중심 사업 재편, 중국 최대 이커머스 생태계 및 대규모 자사주 매입을 통한 주주환원 강화.\n단점 및 리스크: 공산당의 정치적 통제 리스크(과거 앤트그룹 상장 중단 및 과징금), 테무·더우인 등과의 출혈 경쟁에 따른 점유율 잠식. (이건 확인이 필요한 부분입니다)",
        "PDD": "PDD 홀딩스 (경영자: 천레이 / 자오자전): 초저가 알고리즘과 테무(Temu)의 글로벌 폭발적 확장, 극단적 원가 절감을 통한 업계 최고 수준의 수익성.\n단점 및 리스크: 불투명한 회계 공시 및 폐쇄적 거버넌스, 악성코드 의혹·강제노동 연루 조사·소액 면세 폐지 등 전 세계적 규제 직면. (이건 확인이 필요한 부분입니다)",
        "JD": "징동닷컴 (경영자: 쉬란): 자체 직영 풀필먼트 물류망 기반의 강력한 공급망 통제력과 신뢰도 높은 정품 배송 경쟁력.\n단점 및 리스크: 창업자(류창둥)의 1인 지배력 및 사생활 구설, 중국 내수 소비 둔화와 초저가 플랫폼 대비 성장 탄력 약화. (이건 확인이 필요한 부분입니다)",
        "NTES": "넷이즈 (경영자: 딩레이): 자체 개발 R&D 역량을 바탕으로 한 강력한 게임 IP 파이프라인과 안정적인 고마진 현금 창출력.\n단점 및 리스크: 중국 정부의 불시 판호(서비스 허가) 규제 및 미성년자 이용 제한, 글로벌 파트너십 마찰 이력. (이건 확인이 필요한 부분입니다)",
        "BIDU": "바이두 (경영자: 리옌훙): 검색 본업의 안정적 캐시카우와 중국 내 최고 수준의 AI(어니봇) 및 자율주행(아폴로) 기술력.\n단점 및 리스크: 과거 허위 의료광고 방조 사건으로 인한 신뢰 실추, 미국의 첨단 AI 반도체 수출 통제에 따른 인프라 병목. (이건 확인이 필요한 부분입니다)",
        "TCOM": "트립닷컴 그룹 (경영자: 쑨제 / 량젠장): 중국 리오프닝 및 글로벌 플랫폼 확장을 통한 크로스보더 여행 시장의 독보적 지배력.\n단점 및 리스크: 과거 보험 끼워팔기 등 불공정 거래 조사 이력, 지정학적 긴장 및 글로벌 데이터 보안 규제 강화에 취약. (이건 확인이 필요한 부분입니다)",
        "YUMC": "얌 차이나 (경영자: 조이 와트): KFC·피자헛의 철저한 현지화 메뉴와 소형 매장 중심의 디지털 공급망을 통한 위기 방어력.\n단점 및 리스크: 외식 프랜차이즈 특유의 식자재 위생 파동 위험, 중국 외식업계의 전방위 저가 할인 경쟁에 따른 마진 압박. (이건 확인이 필요한 부분입니다)",
        "NIO": "니오 (경영자: 리빈): 독보적인 배터리 스왑(BaaS) 인프라와 프리미엄 유저 커뮤니티 팬덤 구축.\n단점 및 리스크: 과거 분식회계 의혹 리포트 및 지속적인 대규모 적자, 잦은 유상증자로 인한 심각한 주주가치 희석. (이건 확인이 필요한 부분입니다)",
        "LI": "리 오토 (경영자: 리샹): EREV(주행거리 연장형 전기차) 시장 선점으로 스타트업 중 최초 연간 흑자 달성 및 뛰어난 자본 효율성.\n단점 및 리스크: 순수 전기차(BEV) 라인업 확장 실패 시 설비투자 부담 급증, 전기차 가격 인하 전쟁에 따른 수익성 훼손. (이건 확인이 필요한 부분입니다)",
        "XPEV": "샤오펑 (경영자: 허샤오펑): 자율주행(XNGP) 소프트웨어 및 AI 아키텍처 역량 우수, 폭스바겐 지분 투자를 통한 기술력 입증.\n단점 및 리스크: 과거 기술 기밀 유출 소송 구설, 라인업 간 가격 간섭과 만성적인 영업 적자로 인한 현금 소진. (이건 확인이 필요한 부분입니다)",
        "ZTO": "ZTO 익스프레스 (경영자: 라이메이쑹): 네트워크 파트너십과 대규모 자동화 터미널 투자를 결합한 중국 택배업계 최저 원가 경쟁력.\n단점 및 리스크: 공매도 기관의 회계 마진 부풀리기 의혹 제기 이력, 택배 단가 인하 치킨게임 및 인건비 상승 압박. (이건 확인이 필요한 부분입니다)",
        "BEKE": "KE 홀딩스 (경영자: 펑용동): 온·오프라인을 결합한 중국 1위 부동산 중개 플랫폼(베이커)으로서의 독점적 데이터 네트워크.\n단점 및 리스크: 공매도 기관의 유령 중개소 허위 매출 공격 이력, 중국 부동산 개발사 디폴트 및 주택 시장 장기 침체 타격. (이건 확인이 필요한 부분입니다)",
        "TME": "텐센트 뮤직 엔터테인먼트 (경영자: 로스 량 / 커슨 팡): 음원 유료 구독 모델(SVOD) 전환 성공과 텐센트 생태계 음원 IP 독점을 통한 안정적 이익 성장.\n단점 및 리스크: 과거 독점 판권 남용에 따른 SAMR 반독점 과징금 처분, 더우인(틱톡) 등 숏폼 플랫폼으로의 트래픽 이탈. (이건 확인이 필요한 부분입니다)",
        "BILI": "빌리빌리 (경영자: 천루이): 충성도 높은 Z세대 서브컬처 팬덤 커뮤니티와 강력한 크리에이터 생태계 보유.\n단점 및 리스크: 유해 콘텐츠 방조에 따른 공산당 검열 제재 빈번, 지속적인 영업 적자 탈피를 위한 상업화 시 유저 이탈 딜레마. (이건 확인이 필요한 부분입니다)",
        "FUTU": "푸투 홀딩스 (경영자: 리화): 뛰어난 UI/UX의 리테일 핀테크 플랫폼(Moomoo)을 바탕으로 싱가포르·미국·일본 등 글로벌 확장 성공.\n단점 및 리스크: 중국 당국의 무면허 국경 간 증권 거래 규제로 본토 앱 삭제 처분, 글로벌 증시 거래대금 급감 시 취약. (이건 확인이 필요한 부분입니다)",

        "005930": "삼성전자 (경영자: 전영현 / 한종희): D램·낸드 플래시 메모리 및 스마트폰 세계 1위의 방대한 하드웨어 포트폴리오와 막대한 현금 보유량.\n단점 및 리스크: 과거 총수 사법 리스크 및 첫 총파업 겪음, HBM 실기와 파운드리 수율 난항으로 인한 경쟁력 약화. (이건 확인이 필요한 부분입니다)",
        "000660": "SK하이닉스 (경영자: 곽노정): 엔비디아 공급망 독점을 기반으로 한 차세대 HBM 시장의 압도적 기술 리더십과 기민한 설비투자.\n단점 및 리스크: 특정 AI 고객사 의존도가 절대적이며, 메모리 다운사이클 진입 시 막대한 고정비와 차입금 부담 급증. (이건 확인이 필요한 부분입니다)",
        "373220": "LG에너지솔루션 (경영자: 김동명): 글로벌 최상위권 배터리 수주 잔고와 북미 시장 선제적 JV 공장 구축을 통한 시장 선점.\n단점 및 리스크: 과거 조 단위 화재 리콜 충당금 사태, 전기차 캐즘 장기화에 따른 가동률 하락 및 중국 LFP 공세. (이건 확인이 필요한 부분입니다)",
        "207940": "삼성바이오로직스 (경영자: 존 림): 세계 최대 생산능력과 글로벌 빅파마 장기 CMO 계약을 바탕으로 한 압도적인 영업이익률.\n단점 및 리스크: 과거 분식회계 장기 사법 리스크, 단일 플랜트 오염 사고 발생 시 천문학적 배상금 및 수주 취소 위험. (이건 확인이 필요한 부분입니다)",
        "005380": "현대차 (경영자: 정의선 / 호세 무뇨스): 하이브리드·전기차 유연 생산 체계와 제네시스·SUV 믹스 개선으로 역대 최대 실적 및 주주환원 확대.\n단점 및 리스크: 과거 세타2 엔진 결함 충당금 반영 이력, 미국 관세 부과 위험 및 자율주행·SDV 전환 지연 우려. (이건 확인이 필요한 부분입니다)",
        "000270": "기아 (경영자: 송호성): 글로벌 완성차 업계 최상위권 영업이익률 달성과 공격적인 자사주 매입·소각 등 주주친화 정책.\n단점 및 리스크: 미국 내 도난 방지 장치 미장착 집단소송 합의금 지출, 보호무역주의 관세 장벽에 따른 실적 변동성. (이건 확인이 필요한 부분입니다)",
        "068270": "셀트리온 (경영자: 서정진 / 김형기): 헬스케어 합병 완수를 통한 지배구조 단순화 및 미국 짐펜트라 신약 직판망 구축을 통한 외형 성장.\n단점 및 리스크: 과거 일감 몰아주기 회계 논란 꼬리표, 미국 직판망 안착 지연 시 마케팅비 급증 및 상각비 부담. (이건 확인이 필요한 부분입니다)",
        "005490": "POSCO홀딩스 (경영자: 장인화): 세계 최고 수준의 철강 제조 경쟁력과 리튬·양극재 등 완결형 이차전지 소재 밸류체인 구축.\n단점 및 리스크: 정권 교체기 정경유착 구설 및 이사회 수사 이력, 이차전지 소재 손상차손과 중국산 저가 철강재 공습. (이건 확인이 필요한 부분입니다)",
        "035420": "NAVER (경영자: 최수연): 국내 검색·커머스 생태계 장악력과 포시마크 조기 흑자 달성, 생성형 AI(하이퍼클로바X) B2B 도입.\n단점 및 리스크: 과거 댓글 조작 방조 및 알고리즘 자사 우대 과징금, 라인야후 사태 등 해외 사업 지정학적 리스크. (이건 확인이 필요한 부분입니다)",
        "028260": "삼성물산 (경영자: 오세철 / 고정석 / 정해린): 하이테크 플랜트 수주 경쟁력, 안정적 배당 수익 및 자사주 전량 소각 계획 발표 등 밸류업 선도.\n단점 및 리스크: 과거 합병 비율 조작 의혹 및 ISDS 배상 판결 등 정당성 리스크, 복합 지주사 디스카운트. (이건 확인이 필요한 부분입니다)",
        "006400": "삼성SDI (경영자: 최윤호): 철저한 수익성 중심의 질적 성장 기조, 46파이 및 전고체 배터리 분야의 기술적 우위.\n단점 및 리스크: 과거 배터리 발화 리콜 전력, 보수적 투자로 인한 전기차 회복기 점유율 도태 우려. (이건 확인이 필요한 부분입니다)",
        "105560": "KB금융 (경영자: 양종희): 비은행 포트폴리오를 완비한 리딩금융 지위, 은행권 최고 수준의 주주환원율 로드맵 제시.\n단점 및 리스크: 홍콩 ELS 대규모 불완전판매 배상금 지급, 부동산 PF 부실 및 대출 총량 규제에 따른 마진 압박. (이건 확인이 필요한 부분입니다)",
        "055550": "신한지주 (경영자: 진옥동): 해외 법인 성장 및 비이자이익 확대, ROE 중심의 감축형 자사주 소각 등 적극적인 주주환원.\n단점 및 리스크: 과거 라임펀드 사태 징계 및 채용 비리 연루 전력, 해외 부동산 펀드 손실과 ELS 배상 부담. (이건 확인이 필요한 부분입니다)",
        "051910": "LG화학 (경영자: 신학철): 친환경 소재, 전지 소재, 신약 등 3대 신성장 동력 중심의 고부가 스페셜티 포트폴리오 전환.\n단점 및 리스크: 핵심 배터리 사업부 물적분할로 인한 모회사 주주가치 훼손 논란, 인도 공장 참사 배상금 및 석화 부진. (이건 확인이 필요한 부분입니다)",
        "032830": "삼성생명 (경영자: 홍원학): IFRS17 제도 하의 견고한 CSM 성장과 삼성 금융 계열사 간 시너지를 통한 안정적 배당 매력.\n단점 및 리스크: 과거 암 입원비 미지급 소송 제재 이력, 삼성생명법(보험업법 개정안) 통과 시 삼성전자 지분 강제 매각 위험. (이건 확인이 필요한 부분입니다)",
        "086790": "하나금융지주 (경영자: 함영주): 외환 및 중소기업 대출 영업력 우위와 지속적인 자사주 매입 소각을 통한 저평가 해소 추진.\n단점 및 리스크: 채용 비리 관련 사법 공방 및 DLF 불완전판매 징계 이력, 비은행 포트폴리오의 상대적 취약성. (이건 확인이 필요한 부분입니다)",
        "035720": "카카오 (경영자: 정신아): 국민 메신저 카카오톡 기반의 독보적 플랫폼 트래픽과 AI 에이전트 서비스(카나나) 도입.\n단점 및 리스크: 창업자 시세조종 구속기소 및 경영진 먹튀 논란 등 거버넌스 붕괴, 데이터센터 먹통 사태로 신뢰 추락. (이건 확인이 필요한 부분입니다)",
        "138040": "메리츠금융지주 (경영자: 김용범 / 조정호): 순이익의 50%를 환원하는 파격적인 주주가치 제고와 철저한 ROE 위주의 자본 효율적 경영.\n단점 및 리스크: 전 임직원의 미공개 정보 부동산 취득 압수수색 이력, 높은 부동산 PF 익스포저에 따른 잠재 부실 위험. (이건 확인이 필요한 부분입니다)",
        "012330": "현대모비스 (경영자: 이규석): 글로벌 완성차 대상 비계열사 전장 수주 사상 최대 달성 및 핵심 모듈 부품 공급망 독점.\n단점 및 리스크: 과거 지배구조 개편 시 합병 비율 불공정 논란, 그룹 지배구조 개편 과정에서의 주주가치 희석 불확실성. (이건 확인이 필요한 부분입니다)",
        "066570": "LG전자 (경영자: 조주완): B2B(냉난방공조 HVAC·전장) 비중 확대와 가전 구독 및 webOS 플랫폼 등 고마진 사업 전환.\n단점 및 리스크: 과거 스마트폰 사업부 5조 원 누적 적자 방치 전력, 글로벌 가전 수요 정체 및 해상 물류비 급등. (이건 확인이 필요한 부분입니다)",
        "034730": "SK (경영자: 장용호 / 최태원): 그룹 차원의 비핵심 자산 매각과 포트폴리오 리밸런싱을 통한 재무 건전성 및 밸류업 집중.\n단점 및 리스크: 무리한 차입 M&A로 인한 부채 급증 및 계열사 합병 비율 논란, 총수 이혼 소송에 따른 지배구조 불안. (이건 확인이 필요한 부분입니다)",
        "329180": "HD현대중공업 (경영자: 이상균 / 노진율): 조선업 슈퍼사이클 속 고선가 LNG선 및 친환경 암모니아·메탄올 선박 수주 독점.\n단점 및 리스크: KDDX 군사기밀 유출 유죄 판결에 따른 제재, 조선소 중대재해 발생 시 조업 중단 및 숙련공 부족. (이건 확인이 필요한 부분입니다)",
        "000810": "삼성화재 (경영자: 이문화): 손보업계 압도적 이익 1위, 최저 수준의 손해율 관리와 견고한 지급여력비율(K-ICS).\n단점 및 리스크: 백내장 등 실손보험금 부지급 집단 민원 및 담합 과징금 리스크, 초고령화에 따른 장기보험 지급 급증. (이건 확인이 필요한 부분입니다)",
        "316140": "우리금융지주 (경영자: 임종룡): 동양생명·ABL생명 인수 및 증권사 출범을 통한 종합금융그룹 포트폴리오 완성.\n단점 및 리스크: 전임 회장 친인척 부당대출 비리 및 반복된 대규모 직원 횡령 등 금융권 최악의 내부통제 부실. (이건 확인이 필요한 부분입니다)",
        "010130": "고려아연 (경영자: 최윤범 / 박기덕): 비철금속 제련 세계 1위의 독점적 기술력과 트로이카 드라이브(신재생·이차전지 소재) 신사업.\n단점 및 리스크: 경영권 분쟁 중 2.5조 원 기습 유상증자 시도 등 거버넌스 파탄, MBK 연합과의 분쟁 장기화 출혈. (이건 확인이 필요한 부분입니다)",
        "011200": "HMM (경영자: 김경배): 해운 호황기를 거치며 축적된 막대한 순현금 보유량과 친환경 대형 선대 경쟁력.\n단점 및 리스크: 과거 분식회계로 인한 국유화 전력, 영구전환사채(CB) 주식 전환에 따른 막대한 오버행(매물 부담). (이건 확인이 필요한 부분입니다)",
        "033780": "KT&G (경영자: 방경만): 해외 궐련 및 전자담배(NGP) 중심의 글로벌 확장과 대규모 자사주 소각 등 주주환원 확대.\n단점 및 리스크: 과거 해외 법인 비자금 의혹 및 셀프 연임 낙하산 논란, 글로벌 ESG 흡연 규제 강화 추세. (이건 확인이 필요한 부분입니다)",
        "015760": "한국전력 (경영자: 김동철): 대한민국 전력망 및 전력 판매의 독점적 사업자로서의 국가 기간 인프라 지배력.\n단점 및 리스크: 포퓰리즘성 요금 동결로 인한 200조 원대 누적 부채와 천문학적 이자 부담, 원가 전가 불가 규제 리스크. (이건 확인이 필요한 부분입니다)",
        "259960": "크래프톤 (경영자: 김창한): 메가 IP '배틀그라운드'의 글로벌 롱런 흥행과 인도 시장 독점, 높은 영업이익률.\n단점 및 리스크: 상장 당시 고평가 공모가 거품 논란, 전체 매출의 PUBG 단일 IP 의존도 과다로 차기작 검증 미흡. (이건 확인이 필요한 부분입니다)",
        "018260": "삼성에스디에스 (경영자: 황성우): 생성형 AI 플랫폼(FabriX) 및 엔터프라이즈 클라우드 전환, 안정적인 삼성그룹 캡티브 매출.\n단점 및 리스크: 과거 일감 몰아주기 내부거래 과징금 제재, 총수 일가 상속세 납부를 위한 블록딜 출회 위험. (이건 확인이 필요한 부분입니다)",

        "CAT": "캐터필러 (경영자: 짐 엄플비): 미국 인프라 투자 수혜와 압도적 딜러망을 바탕으로 한 강력한 장비 가격 결정력.\n단점 및 리스크: 스위스 자회사를 통한 역외 탈세 혐의로 거액 합의금 납부 이력, 글로벌 경기 침체 시 장비 수요 급락. (이건 확인이 필요한 부분입니다)",
        "BA": "보잉 (경영자: 켈리 오트버그): 에어버스와 함께 글로벌 상용 항공기 시장을 양분하는 대체 불가능한 제조 인프라와 방산 포트폴리오.\n단점 및 리스크: 737 MAX 연쇄 추락 참사 관련 사기 유죄 인정, 품질 관리 붕괴와 500억 달러 부채에 따른 존립 위기. (이건 확인이 필요한 부분입니다)",
        "GM": "제너럴 모터스 (경영자: 메리 바라): 고마진 픽업트럭·SUV 중심의 강력한 현금 창출력과 대규모 자사주 매입을 통한 주당가치 제고.\n단점 및 리스크: 과거 점화스위치 결함 은폐(124명 사망) 형사 처벌 이력, 크루즈 자율주행 사고 은폐 논란. (이건 확인이 필요한 부분입니다)",
        "F": "포드 모터 (경영자: 짐 팔리): 상용차 사업부(Ford Pro)의 독보적 마진율과 충성도 높은 북미 F-150 트럭 브랜드 가치.\n단점 및 리스크: 북미 완성차 리콜 1위의 만성적 품질 결함과 막대한 보증 수리 비용 지출, 1세대 전기차 부문 적자. (이건 확인이 필요한 부분입니다)",
        "DOW": "다우 (경영자: 짐 피털링): 엄격한 CAPEX 통제 및 세계 최초 탄소배출 제로 에틸렌 콤플렉스 추진 등 원가 절감 리더십.\n단점 및 리스크: 과거 PFAS(영구 화학물질) 독성 은폐 및 식수 오염 배상금 판결, 글로벌 석유화학 공급 과잉. (이건 확인이 필요한 부분입니다)",
        "FCX": "프리포트 맥모란 (경영자: 캐슬린 쿼크): AI 데이터센터 및 신재생 전력망 확충에 따른 글로벌 구리 수요 폭증의 직접적 수혜.\n단점 및 리스크: 인도네시아 광산 폐기물 무단 방류 등 환경 파괴 스캔들, 채굴국 정부의 자원 민족주의 세금 인상 압박. (이건 확인이 필요한 부분입니다)",
        "NUE": "뉴코어 (경영자: 레온 토파련): 전기로(EAF) 기반의 유연한 가동률 조절 및 북미 철강 시장 1위의 탁월한 원가 경쟁력.\n단점 및 리스크: 과거 대기오염 위반 EPA 제재 이력, 미국 건설 경기 둔화 및 철강 가격 급락 시 실적 변동성 심화. (이건 확인이 필요한 부분입니다)",
        "DAL": "델타 항공 (경영자: 에드 바스티안): 프리미엄 좌석 비중 확대 및 아메리칸 익스프레스 제휴 카드 로열티 기반의 압도적 수익성.\n단점 및 리스크: IT 대란 당시 최악의 복구 지연에 따른 교통부 조사, 항공 사고 발생 시 여객 급감 및 유가 급등 취약. (이건 확인이 필요한 부분입니다)",
        "UAL": "유나이티드 항공 (경영자: 스콧 커비): 대형기 도입을 통한 좌석당 원가 절감과 대서양·태평양 횡단 국제선 네트워크 경쟁력.\n단점 및 리스크: 과거 승객 강제 퇴선 유혈 폭행 파문, 기체 정비 불량 논란 및 보잉 인도 지연에 따른 운항 차질. (이건 확인이 필요한 부분입니다)",
        "UNP": "유니온 퍼시픽 (경영자: 짐 베나): 정밀스케줄철도(PSR) 운영을 통한 영업비용 극적 개선과 서부 철도 운송의 독점적 해자.\n단점 및 리스크: 과도한 인력 감축으로 인한 탈선 사고 급증 조사, 철도 노조 파업 위협 및 안전 규제 강화 비용. (이건 확인이 필요한 부분입니다)",
        "DE": "디어 앤 컴퍼니 (경영자: 존 메이): 정밀 농업 소프트웨어 구독 모델 구축 및 세계 1위 농기계 브랜드 파워.\n단점 및 리스크: 농민의 자체 수리를 원천 차단하는 소프트웨어 독점으로 미 FTC 조사, 곡물가 하락에 따른 농가 구매력 둔화. (이건 확인이 필요한 부분입니다)",
        "AA": "알코아 (경영자: 윌리엄 오플링어): 호주 알루미나 인수를 통한 상공정 수직계열화와 저탄소 알루미늄 생산 기술 우위.\n단점 및 리스크: 과거 해외 공공 수주 관련 뇌물 공여(FCPA 위반) 거액 벌금 납부, 전력비 급등 및 금속가 변동성. (이건 확인이 필요한 부분입니다)",
        "LEN": "레나 (경영자: 스튜어트 밀러 / 존 재프): 토지를 소유하지 않고 옵션으로 확보하는 에셋 라이트(Asset-Light) 모델을 통한 높은 ROE.\n단점 및 리스크: 과거 모기지 사태 당시 부외부채 은폐 집단소송 이력, 고금리 장기화 시 모기지 바이다운 마진 잠식. (이건 확인이 필요한 부분입니다)",
        "DHI": "DR 호튼 (경영자: 폴 로마노프스키): 미국 1위 주택 건설사로서의 규모의 경제와 저가 보급형 주택 시장 완벽 장악.\n단점 및 리스크: 부실시공 하자 보수 미흡 집단소송 빈번, 주택 구매 여력(Affordability) 한계 도달 시 판매 둔화. (이건 확인이 필요한 부분입니다)",
        "WHR": "월풀 (경영자: 마크 비처): 키친에이드 등 강력한 소형 가전 브랜드 및 유럽 저수익 사업부 구조조정을 통한 내실화.\n단점 및 리스크: 과거 냉장고 컴프레서 가격 담합 반독점 과징금 이력, 아시아 저가 가전 공세로 인한 점유율 잠식. (이건 확인이 필요한 부분입니다)",
        "RCL": "로얄 캐리비안 (경영자: 제이슨 리버티): 초대형 신형 크루즈선 취항을 통한 선상 소비 극대화 및 기록적인 부채 상환 속도.\n단점 및 리스크: 팬데믹 기간 급증한 고금리 순부채 부담, 선내 집단 감염병 및 폐수 무단 방류 환경 제재 위험. (이건 확인이 필요한 부분입니다)",
        "CCL": "카니발 (경영자: 조시 와인스틴): 노후 선박 대거 매각 및 고효율 선대 재편을 통한 턴어라운드와 레저 여행 수요 흡수.\n단점 및 리스크: 코스타 콩코르디아호 좌초 참사 및 해양 폐기물 무단 투기 전력, 300억 달러에 달하는 막대한 부채 이자. (이건 확인이 필요한 부분입니다)",
        "MAR": "메리어트 인터내셔널 (경영자: 앤서니 카푸아노): 1억 9천만 명의 본보이(Bonvoy) 회원을 바탕으로 한 프랜차이즈 수수료 수취 자산 경량화 모델.\n단점 및 리스크: 3억 8천만 명 개인정보 유출 참사 거액 과징금 이력, 리조트 피 은폐 허위광고 소송. (이건 확인이 필요한 부분입니다)",
        "HLT": "힐튼 월드와이드 (경영자: 크리스토퍼 나세타): 100% 프랜차이즈 기반의 탁월한 자본수익률과 럭셔리 라이프스타일 브랜드 확장.\n단점 및 리스크: 과거 경쟁사 영업비밀 조직적 탈취 유죄 판결 배상 이력, 경기 침체 시 출장 수요 감소 타격. (이건 확인이 필요한 부분입니다)",
        "EXPE": "익스피디아 (경영자: 아리안 고린): B2B 여행 파트너 솔루션 급성장과 원키(One Key) 통합 로열티 프로그램을 통한 플랫폼 시너지.\n단점 및 리스크: 호텔 최저가 강제(최혜국 대우) 반독점 과징금 제재, 구글 여행 검색의 자사 우대 및 에어비앤비 공세. (이건 확인이 필요한 부분입니다)",

        "MSFT": "마이크로소프트 (경영자: 사티아 나델라): 오픈AI 파트너십을 통한 기업용 AI(Azure·Copilot) 시장 장악 및 다각화된 클라우드 생태계.\n단점 및 리스크: 팀즈 끼워팔기 및 오픈AI 투자 관련 FTC·EU 반독점 조사, 거대 클라우드 보안 침해 사고 빈번. (이건 확인이 필요한 부분입니다)",
        "AAPL": "애플 (경영자: 팀 쿡): 전 세계 1위 하드웨어 생태계 락인과 고마진 서비스 매출, 천문학적 자사주 매입 주주환원.\n단점 및 리스크: 미 법무부의 아이폰 독점 반독점 소송 패소 위협, EU의 130억 유로 불법 세금 감면 추징 확정 판결. (이건 확인이 필요한 부분입니다)",
        "NVDA": "엔비디아 (경영자: 젠슨 황): GPU 하드웨어와 CUDA 소프트웨어가 결합된 독점적 AI 컴퓨팅 풀스택 플랫폼.\n단점 및 리스크: CUDA 종속 결합판매에 대한 반독점 조사, 미 정부의 대중 반도체 수출 규제 및 빅테크 자체 칩 전환. (이건 확인이 필요한 부분입니다)",
        "GOOGL": "알파벳 (경영자: 순다르 피차이): 검색 독점력을 바탕으로 한 막대한 광고 현금흐름, GCP 흑자 및 제미나이(Gemini) AI 풀스택 경쟁력.\n단점 및 리스크: 미 법무부 검색 독점 소송 패소에 따른 크롬 강제 매각 위기, AI 검색 전환에 따른 마진 훼손. (이건 확인이 필요한 부분입니다)",
        "GOOG": "알파벳 (경영자: 순다르 피차이): 검색 독점력을 바탕으로 한 막대한 광고 현금흐름, GCP 흑자 및 제미나이(Gemini) AI 풀스택 경쟁력.\n단점 및 리스크: 미 법무부 검색 독점 소송 패소에 따른 크롬 강제 매각 위기, AI 검색 전환에 따른 마진 훼손. (이건 확인이 필요한 부분입니다)",
        "AMZN": "아마존 (경영자: 앤디 재시): AWS 클라우드의 AI 가속화, 지역화된 배송 물류 혁신 및 폭발적인 디지털 광고 수익.\n단점 및 리스크: FTC로부터 알고리즘 입점업체 착취 반독점 소송 피소, 물류창고 노동환경 논란 및 테무·쉬인 저가 공세. (이건 확인이 필요한 부분입니다)",
        "META": "메타 플랫폼스 (경영자: 마크 저커버그): 릴스(Reels) AI 추천 고도화로 광고 마진 극대화 및 오픈소스 AI(Llama) 생태계 주도.\n단점 및 리스크: CA 8,700만 명 개인정보 유출(50억 달러 벌금), 청소년 SNS 중독 소송 및 메타버스 연간 수조 원 적자. (이건 확인이 필요한 부분입니다)",
        "BRK-B": "버크셔 해서웨이 (경영자: 워런 버핏 / 그렉 아벨): 보험 플로트(Float)를 활용한 영구 자본 기반과 철저한 안전마진 원칙의 자본 배분 성과.\n단점 및 리스크: 워런 버핏 사후 승계 시 버핏 프리미엄 소멸 우려, 복합기업 지배구조에 대한 시장 의구심. (이건 확인이 필요한 부분입니다)",
        "LLY": "일라이 릴리 (경영자: 데이비드 릭스): 마운자로·젭바운드(GLP-1 비만/당뇨 치료제)와 알츠하이머 신약을 앞세운 글로벌 헬스케어 1위.\n단점 및 리스크: 과거 조현병약 불법 마케팅 14억 달러 형사 벌금 전력, 정부 약가 인하 압박 및 불법 배합약 유통. (이건 확인이 필요한 부분입니다)",
        "AVGO": "브로드컴 (경영자: 호크 탄): 맞춤형 AI ASIC(커스텀 칩) 설계 및 초고속 네트워킹 독점, 공격적 M&A를 통한 잉여현금 극대화.\n단점 및 리스크: 과거 국가안보(CFIUS) 인수 불허 이력, VM웨어 인수 후 일방적 가격 인상에 따른 고객 이탈 반발. (이건 확인이 필요한 부분입니다)",
        "TSLA": "테슬라 (경영자: 일론 머스크): 전기차 제조 혁신, 자체 충전망(슈퍼차저) 및 FSD·로보택시·휴머노이드 로봇 생태계.\n단점 및 리스크: 머스크의 560억 달러 보수 무효 판결 등 거버넌스 리스크, FSD 과장 광고 관련 법무부 형사 조사. (이건 확인이 필요한 부분입니다)",
        "JPM": "JP모건 체이스 (경영자: 제이미 다이먼): 미국 최대 상업은행으로서의 독보적 자본력, 위기 시 부실은행 인수를 통한 시장 지배력 확장.\n단점 및 리스크: 과거 귀금속 시세조종(스푸핑) 거액 벌금 납부, 엡스타인 불법 자금 세탁 방조 합의금 등 도덕적 오점. (이건 확인이 필요한 부분입니다)",
        "WMT": "월마트 (경영자: 더그 맥밀런): 온·오프라인 옴니채널 유통 장악력, 월마트+ 멤버십 안착 및 고마진 리테일 미디어 광고 성장.\n단점 및 리스크: 멕시코 매장 인허가 뇌물 공여(FCPA 위반) 벌금, 오피오이드 불법 처방 방조 31억 달러 합의금 지출. (이건 확인이 필요한 부분입니다)",
        "XOM": "엑슨모빌 (경영자: 대런 우즈): 퍼미안 셰일 유전 인수를 통한 저원가 원유 생산 규모의 경제와 기록적인 잉여현금 창출.\n단점 및 리스크: 수십 년간 기후변화 연구 은폐(Exxon Knew) 사기 소송, 탄소중립 전환에 따른 좌초자산화 위험. (이건 확인이 필요한 부분입니다)",
        "UNH": "유나이티드헬스 그룹 (경영자: 앤드루 위티): 미국 최대 의료보험(UHC)과 헬스케어 데이터·서비스(Optum)의 결합을 통한 현금흐름 창출.\n단점 및 리스크: 체인지 헬스케어 해킹 사태로 전미 의료 마비 배상금, 메디케어 과다 청구 사기 의혹 및 PBM 반독점 조사. (이건 확인이 필요한 부분입니다)",
        "V": "비자 (경영자: 라이언 맥이너니): 전 세계 신용카드 결제망을 과점하며 인플레이션을 헷지하는 독보적 수수료 비즈니스 모델.\n단점 및 리스크: 미 법무부로부터 체크카드 독점 반독점 소송 피소, 가맹점 수수료 담합 집단소송 및 정부 수수료 상한제. (이건 확인이 필요한 부분입니다)",
        "MA": "마스터카드 (경영자: 마이클 미에바흐): 비접촉 결제 침투 및 데이터 보안·토큰화 부가 서비스 확장을 통한 견고한 영업이익률.\n단점 및 리스크: 영국 23조 원 규모 불법 수수료 담합 집단소송 겪음, 신흥국 정부 주도 결제망 확산에 따른 네트워크 이탈. (이건 확인이 필요한 부분입니다)",
        "PG": "프록터 앤 갬블 (경영자: 존 뮬러): 타이디, 팸퍼스 등 필수 소비재 1등 브랜드의 가격 전가력과 안정적인 연속 배당 성장.\n단점 및 리스크: 과거 유럽 세제 가격 담합 과징금 부과 전력, 드라이샴푸 발암물질(벤젠) 검출 리콜 및 PB 상품 추격. (이건 확인이 필요한 부분입니다)",
        "JNJ": "존슨앤드존슨 (경영자: 호아킨 두아토): 소비자 사업 분사 후 고마진 혁신 신약 및 정형외과·심혈관 의료기기(MedTech) 집중 체제 완성.\n단점 및 리스크: 베이비파우더 석면 난소암 유발 수만 건 소송과 파산 꼼수 비판, 오피오이드 50억 달러 합의 등 배상 리스크. (이건 확인이 필요한 부분입니다)",
        "HD": "홈디포 (경영자: 테드 데커): 전문 건축업자(Pro) 대상 B2B 유통망(SRS 인수) 장악과 안정적인 주택 개보수 독점력.\n단점 및 리스크: 과거 5,600만 건 카드 정보 유출 해킹 합의금, 미국 주택 매매 거래 동결에 따른 동일 매장 성장 정체. (이건 확인이 필요한 부분입니다)",
        "ORCL": "오라클 (경영자: 사프라 카츠 / 래리 엘리슨): 멀티 클라우드(MS·구글·AWS 제휴) 데이터베이스 구축 및 AI 스타트업용 OCI 인프라 수주 폭증.\n단점 및 리스크: 자바(Java) 저작권 침해 소송 10년 공방 패소, 세르너(Cerner) 의료 시스템 결함에 따른 정부 계약 차질. (이건 확인이 필요한 부분입니다)",
        "COST": "코스트코 (경영자: 론 바크리스): 최저 마진·최고 품질 원칙을 통한 93%의 북미 회원 갱신율과 안정적인 연회비 현금흐름.\n단점 및 리스크: 티파니 상표 무단 도용 판결 배상 이력, 이커머스 디지털 전환의 상대적 지연 및 자사 계육 복지 논란. (이건 확인이 필요한 부분입니다)",
        "MRK": "머크 (경영자: 로버트 데이비스): 세계 1위 면역항암제 '키트루다'의 압도적 매출 성장과 공격적인 면역질환 M&A 파이프라인.\n단점 및 리스크: 과거 관절염약(바이옥스) 심장마비 부작용 은폐로 수만 명 사망 참사 이력, 2028년 키트루다 특허 절벽. (이건 확인이 필요한 부분입니다)",
        "ABBV": "애브비 (경영자: 로버트 마이클): 휴미라 특허 만료 후 차세대 자가면역 치료제(스카이리치·린버크)의 완벽한 세대교체 성공.\n단점 및 리스크: 과거 100여 개 특허 덤불로 복제약 진입 방해 의회 조사, 세레벨 인수 등으로 늘어난 레버리지 부담. (이건 확인이 필요한 부분입니다)",
        "CRM": "세일즈포스 (경영자: 마크 베니오프): SaaS CRM 시장 1위와 자율형 AI 에이전트(에이전트포스) 출시, 배당·자사주 매입 개시.\n단점 및 리스크: 과거 인신매매 사이트에 자사 SW 제공 인신매매 방조 피소 흠결, 무리한 M&A 후 대규모 정리해고 단행. (이건 확인이 필요한 부분입니다)",
        "CVX": "셰브론 (경영자: 마이크 워스): 엄격한 자본 규율을 바탕으로 한 저원가 원유 시추와 헤스(Hess) 인수를 통한 신규 유전 확보.\n단점 및 리스크: 에콰도르 아마존 독성 폐수 무단 투기 수조 원대 소송 전력, 헤스 인수 관련 엑슨모빌과의 중재 분쟁. (이건 확인이 필요한 부분입니다)",
        "AMD": "AMD (경영자: 리사 수): 서버용 CPU(EPYC) 점유율 확대와 AI 가속기(MI300/325) 출시로 엔비디아의 유일한 대항마 안착.\n단점 및 리스크: TSMC에 100% 제조를 의존하는 대만 지정학적 리스크, 엔비디아 CUDA 대비 부족한 소프트웨어 스택. (이건 확인이 필요한 부분입니다)",
        "BAC": "뱅크 오브 아메리카 (경영자: 브라이언 모이니핸): 탄탄한 리테일 예금 기반과 모바일 뱅킹 기술력을 통한 안정적 순이자이익 창출.\n단점 및 리스크: 2008년 부실 모기지 사기 판매로 미 역사상 최대 166억 달러 벌금 납부, 유령 계좌 개설 CFPB 제재. (이건 확인이 필요한 부분입니다)",
        "KO": "코카콜라 (경영자: 제임스 퀸시): 보틀링 자산 매각(Refranchising)을 통한 자산 경량화 및 제로 슈거 등 글로벌 음료 브랜드 파워.\n단점 및 리스크: 역외 탈세 혐의로 미 국세청(IRS)에 60억 달러 세금 추징 판결, 전 세계 1위 플라스틱 배출 규제 리스크. (이건 확인이 필요한 부분입니다)",
        "NFLX": "넷플릭스 (경영자: 테드 사란도스 / 그렉 피터스): 계정 공유 유료화 및 광고 요금제 대성공, 글로벌 자체 제작 IP를 통한 스트리밍 독점력.\n단점 및 리스크: 통신망 무임승차(망 사용료) 분쟁 및 조세회피처 세무조사, 가입자 정체 시 막대한 제작비의 FCF 훼손. (이건 확인이 필요한 부분입니다)",
        "PEP": "펩시코 (경영자: 라몬 라구아르타): 프리토레이 스낵과 음료 포트폴리오의 탄탄한 시장 지배력 및 강력한 가격 전가력.\n단점 및 리스크: 과도한 가격 인상(그리드플레이션)에 따른 유럽 대형마트 퇴출 사태, 플라스틱 공해 피소 및 북미 판매량 둔화. (이건 확인이 필요한 부분입니다)"
    }
