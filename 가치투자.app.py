...
fallback_13f_data = {
    ...
    "DALIO": [{"티커": "SPY", "기업명": "SPDR S&P 500 ETF", "비중(%)": 16.3}, {"티커": "IVV", "기업명": "iShares Core S&P 500 ETF", "비중(%)": 9.2}, {"티커": "NVDA", "기업명": "NVIDIA", "비중(%)": 3.2}, {"티커": "AVGO", "기업명": "Broadcom", "비중(%)": 1.9}, {"티커": "AMZN", "기업명": "Amazon", "비중(%)": 1.8}, {"티커": "META", "기업명": "Meta Platforms", "비중(%)": 1.5}, {"티커": "JNJ", "기업명": "Johnson & Johnson", "비중(%)": 1.3}],
    "DRUCK": [{"티커": "NTRA", "기업명": "Natera", "비중(%)": 16.6}, {"티커": "INSM", "기업명": "Insmed", "비중(%)": 5.7}, {"티커": "TSM", "기업명": "TSMC", "비중(%)": 5.4}, {"티커": "IBIT", "기업명": "iShares Bitcoin Trust", "비중(%)": 5.1}, {"티커": "AMZN", "기업명": "Amazon", "비중(%)": 4.6}, {"티커": "SE", "기업명": "Sea Ltd", "비중(%)": 4.1}, {"티커": "VRT", "기업명": "Vertiv", "비중(%)": 3.8}],
    "TEPPER": [{"티커": "BABA", "기업명": "Alibaba Group", "비중(%)": 12.5}, {"티커": "META", "기업명": "Meta Platforms", "비중(%)": 10.2}, {"티커": "MSFT", "기업명": "Microsoft", "비중(%)": 9.5}, {"티커": "AMZN", "기업명": "Amazon", "비중(%)": 8.8}, {"티커": "NVDA", "기업명": "NVIDIA", "비중(%)": 7.2}, {"티커": "PDD", "기업명": "PDD Holdings", "비중(%)": 5.5}, {"티커": "BIDU", "기업명": "Baidu", "비중(%)": 4.2}]
}
...
with tab2:
    ...
    st.markdown("### 인물 개요")
    if guru_option == "레이 달리오 (Bridgewater)":
        st.write("**레이 달리오(Ray Dalio):** 세계 최대 헤지펀드 브리지워터의 창립자로, 경제 기계가 작동하는 원리(매크로)를 꿰뚫어 보는 거장입니다. 위험을 분산하는 '올웨더 포트폴리오' 철학을 기반으로 S&P 500 ETF와 우량 메가테크 주식을 섞어 극도의 안정성과 수익을 동시에 추구합니다.")
    elif guru_option == "스탠리 드러켄밀러 (Duquesne)":
        st.write("**스탠리 드러켄밀러(Stanley Druckenmiller):** 30년 넘게 단 한 해도 마이너스 수익률을 기록하지 않은 전설적인 탑다운(Top-down) 매크로 투자자입니다. 트렌드를 남들보다 먼저 포착해 집중 투자하며, 최근에는 AI 사이클(TSMC, 버티브)과 바이오(나테라, 인스메드) 섹터의 압도적인 성장에 베팅하고 있습니다.")
    elif guru_option == "데이비드 테퍼 (Appaloosa)":
        st.write("**데이비드 테퍼(David Tepper):** 극심한 공포가 지배하는 시장에서 헐값이 된 우량 자산을 쓸어 담는 부실채권 및 가치투자 매니저입니다. 최근 13F에서는 저평가된 중국의 핵심 빅테크(알리바바, PDD, 바이두)와 미국의 AI 독점 기업을 바벨 전략으로 양분하여 투자하고 있습니다.")
